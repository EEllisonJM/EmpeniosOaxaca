...
session_start();
ob_start();
error_reporting(E_ALL ^ E_NOTICE);/*Don´t show errar message*/
require("../db/configuracion.php"); //conexion de base de datos
include("menu.php");
...
if ($_SESSION["tipo"] == "ADMINISTRADOR" ||
	...
	if ($_REQUEST['registrar'] == "Registrar") {
		...
		mysqli_query($conexion,
			"INSERT INTO Empleado (idPuesto, apellidoP, apellidoM, nombre,sexo,fecha_nacimiento,telefono,calle,colonia,codigo_postal,ciudad, e_mail,visible)
