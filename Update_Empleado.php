...
mysqli_query($conexion,
	"UPDATE Empleado
		SET idEmpleado=$idEmpleado, idPuesto=$idPuesto, nombre='$nombre',apellidoP='$apellidoP', apellidoM='$apellidoM', sexo='$sexo', telefono='$telefono',calle='$calle',colonia='$colonia',codigo_postal='$codigo_postal',ciudad='$ciudad',e_mail='$e_mail', visible='$visible'
